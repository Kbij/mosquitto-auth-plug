# This is a fork of the original mosquitto-auth-plug
Changed in this version:
* Removed compiler error with mosquitto 1.6.2
* Changed the acl checking (to allow a subscription to: someroot/+/somesub
